...
[source,java]
----
include::../src/main/java/daggerok/thymeleafmvc/ThymeleafProducer.java[tags=content]
----

.configure Thymeleaf view resolver
[source,java]
----
include::../src/main/java/daggerok/thymeleafmvc/ThymeleafViewEngine.java[tags=content]
----
...
[source,java]
----
include::../src/main/java/daggerok/jaxrs/StaticResourcesResource.java[tags=content]
----
...
[source,java]
----
include::../src/main/java/daggerok/thymeleafmvc/IndexPage.java[tags=content]
----
